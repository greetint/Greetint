...
export default function BoardingPassCreatePage() {
  return (
    <div className="min-h-screen bg-[#F0F8FF] text-[#1F1A17] font-sans p-6 sm:p-12 flex flex-col items-center justify-center">
      <div className="max-w-md w-full bg-white p-8 rounded-3xl shadow-xl border border-[#958679]/20 text-center space-y-6">
        ...
        <h1 className="text-2xl font-serif font-bold text-[#11100F]">Boarding Pass</h1>
        <p className="text-xs text-[#11100F]/70 leading-relaxed">
          Този стил е заключен (Очаквайте скоро). Летищна естетика, билети и търкащ се глобус.
        </p>
        <Link 
