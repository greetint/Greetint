...
export default function SecretDiaryCreatePage() {
  return (
    <div className="min-h-screen bg-[#FFE4E1] text-[#1F1A17] font-sans p-6 sm:p-12 flex flex-col items-center justify-center">
      <div className="max-w-md w-full bg-white p-8 rounded-3xl shadow-xl border border-[#958679]/20 text-center space-y-6">
        ...
        <h1 className="text-2xl font-serif font-bold text-[#11100F]">Secret Diary</h1>
        <p className="text-xs text-[#11100F]/70 leading-relaxed">
          Този стил е заключен (Очаквайте скоро). Тайни дневници, пастелни цветове и photo scrapbook.
        </p>
        <Link 
