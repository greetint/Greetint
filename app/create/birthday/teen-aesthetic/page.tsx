...
export default function TeenAestheticCreatePage() {
  return (
    <div className="min-h-screen bg-[#F0F8FF] text-[#1F1A17] font-sans p-6 sm:p-12 flex flex-col items-center justify-center">
      <div className="max-w-md w-full bg-white/85 backdrop-blur-md p-8 rounded-3xl shadow-xl border border-[#958679]/20 text-center space-y-6">
        ...
        <h1 className="text-2xl font-serif font-bold text-[#11100F]">Teen Aesthetic</h1>
        <p className="text-xs text-[#11100F]/70 leading-relaxed">
          Тази форма за тийнейджърски стил е подготвена като независим шаблон и очаква следващия етап на развитие.
        </p>
        <Link 
