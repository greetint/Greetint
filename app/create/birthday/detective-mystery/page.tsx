...
export default function DetectiveMysteryCreatePage() {
  return (
    <div className="min-h-screen bg-[#2C2622] text-[#F7F4EF] font-sans p-6 sm:p-12 flex flex-col items-center justify-center">
      <div className="max-w-md w-full bg-[#1F1A17] p-8 rounded-3xl shadow-2xl border border-[#958679]/30 text-center space-y-6">
        ...
        <h1 className="text-2xl font-serif font-bold text-[#F7F4EF]">Detective Mystery</h1>
        <p className="text-xs text-[#F7F4EF]/70 leading-relaxed">
          Този стил е заключен (Очаквайте скоро). Ноар атмосфера с папки TOP SECRET и дешифриране.
        </p>
        <Link 
