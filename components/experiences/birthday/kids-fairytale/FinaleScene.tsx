...
export function FinaleScene({ childName, senderName, personalMessage, favoriteAnimal }: FinaleSceneProps) {
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-2xl bg-white/95 backdrop-blur-2xl p-8 sm:p-14 rounded-[2.5rem] shadow-2xl border-4 border-amber-300 text-center space-y-6"
    >
      ...
      {!letterOpen ? (
        ...
        >
          ...
          <span className="font-bold text-sm uppercase tracking-widest">Отвори тайното писмо 💌</span>
        </motion.div>
      ) : (
        <motion.div
