...
export function KidsFairytaleExperience({ data }: KidsFairytaleExperienceProps) {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-amber-200 via-orange-100 to-sky-200 text-[#2C241D] font-sans overflow-hidden flex flex-col items-center justify-center p-4 sm:p-6 select-none">
      <div className="absolute top-4 right-4 z-50 flex items-center gap-3">
        <button
          onClick={() => setIsMuted(!isMuted)}
          className="bg-white/90 backdrop-blur-md p-3 rounded-full text-[#2C241D] hover:bg-white shadow-lg border border-white/50 transition cursor-pointer flex items-center gap-2 text-xs font-bold"
      ...
      <div className="text-center text-xs text-[#2C241D]/60 font-serif pb-2 flex items-center justify-center gap-2">
